...
OBJLoader.prototype = {
  ...
  parse: function ( text ) {
    ...
    for ( var i = 0, l = objects.length; i < l; i ++ ) {
      ...
      buffergeometry.attributes.position = new THREE.BufferAttribute( new Float32Array( geometry.vertices ), 3 );

      if ( geometry.normals.length > 0 ) {

        buffergeometry.attributes.normal = new THREE.BufferAttribute( new Float32Array( geometry.normals ), 3 );
      ...
      if ( geometry.uvs.length > 0 ) {
        ...
        buffergeometry.attributes.uv =  new THREE.BufferAttribute( new Float32Array( geometry.uvs ), 2 );
